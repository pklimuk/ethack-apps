                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {comparison.pools.slice(0, 2).map((pool, index) => (
                          <span
                            key={index}
                        ...
                        {comparison.pools.length > 2 && (
                          <span className="text-xs text-gray-500">+{comparison.pools.length - 2}</span>
                        )}
                      </div>
                    </div>
                    <button
          ...
          {selectedComparison ? (
            ...
            <div className="flex items-center justify-center py-16">
              <div className="text-center">
                ...
                <p className="text-gray-500">Select a comparison above to view details</p>
              </div>
            </div>
          )}
        </div>
